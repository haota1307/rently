        ...
        {!user ? (
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h3 className="font-medium text-sm text-gray-500">Họ và tên</h3>
            ...
            <div className="border-t pt-3 mt-3">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm">{formatDate(userDetail.createdAt)}</p>
                </div>
                <div>
                  <h3 className="font-medium text-sm text-gray-500">
                    Cập nhật lần cuối
                  </h3>
                  <p className="text-sm">{formatDate(userDetail.updatedAt)}</p>
                </div>
              </div>
            </div>
